package br.com.heiderlopes.notaskotlin.controller
...
import br.com.heiderlopes.notaskotlin.service.NotaService
...
class NotaController {
    ...
    internal fun buscar(@PathVariable(value = "titulo") titulo: String): Nota {
